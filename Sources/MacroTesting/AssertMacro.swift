...
public func assertMacro(
  ...
  diagnoses diagnosedSource: (() -> String)? = nil,
    ...
    if !allDiagnostics.isEmpty || diagnosedSource != nil {
      ...
      assertInlineSnapshot(
        ...
        syntaxDescriptor: InlineSnapshotSyntaxDescriptor(
          trailingClosureLabel: "diagnoses",
...
/// Asserts that a given Swift source string matches an expected string with all macros expanded.
///
/// See ``assertMacro(_:record:of:diagnoses:fixes:expandsTo:file:function:line:column:)-6kg0r`` for
/// more details.
///
/// - Parameters:
///   - macros: The macros to expand in the original source string. Required, either implicitly via
...
public func assertMacro(
  ...
  assertMacro(
    ...
    record: isRecording,
    of: originalSource,
    diagnoses: diagnosedSource,
    fixes: fixedSource,
    expandsTo: expandedSource,
    file: file,
    function: function,
    line: line,
    column: column
